...
Case of 
	: (Form event code:C388=On Mouse Enter:K2:33)
		<>Infos:="This filter will combine both actions described above (Offset + Blur) THEN will apply a blend with the original shape."
		<>Infos:=<>Infos+" On Windows™, only the \"Normal\" Blend mode is supported."
	...
	: (Form event code:C388=On Clicked:K2:4)
		...
		$ref3:=SVG_Filter_Blend($filter; "SourceGraphic"; "alphaBlurOffset"; BlendMode{BlendMode}; "finalFilter"; )
		...
		$textAreaRef:=SVG_New_textArea($g; "Hello World!"; 20; 20; 400; 400; "arial"; 120; Plain:K14:1; Align center:K42:3)
